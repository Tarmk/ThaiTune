  ...
  return (
    <div className="container mx-auto p-6 max-w-4xl">
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Find Users with Generic Names</CardTitle>
            <CardDescription>
          ...
          <CardContent>
            ...
            {users.length > 0 && (
              <div>
                <p className="mb-4">Found {users.length} users with generic names:</p>
                  ...
                  {users.map(user => (
                    <div key={user.id} className="flex items-center justify-between p-3 border rounded-lg">
                      <div>
                        ...
                        <Badge variant="secondary" className="ml-2">{user.id.substring(0, 8)}...</Badge>
                      </div>
                    </div>
                  ))}
                </div>
          ...
          <Card>
            ...
            <CardContent>
              <Alert className="mb-4">
                <AlertDescription>
                  <strong>Note:</strong> This is a simplified version. For full functionality, 
                  you'll need to use Firebase Admin SDK on the server to access user authentication data.
                </AlertDescription>
              </Alert>
            ...
            <div className="space-y-4">
              <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                  Run this in your browser console (F12) while logged in as admin:
                </p>
  ...
  displayName: "New Name Here"
              ...
              <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  For a complete solution, you'll need to create a Cloud Function or server endpoint 
                  that uses Firebase Admin SDK to access user authentication data and update Firestore documents.
                </p>
              </div>
            </div>
          </CardContent>
